...
const Rps3D = (() => {
  ...
  const PATHS = {
    rock: `
      ...
      <path d="M25 35 L40 38 M45 30 L60 32 M65 28 L80 32 M30 50 L50 52 M55 45 L75 48 M35 65 L55 68 M60 62 L85 65" fill="none" stroke="#8b4513" stroke-width="1.5" opacity="0.6"/>
      <path d="M42 21 L40 45 M58 21 L60 45 M75 31 L72 55 M22 55 L45 58 M28 72 L50 75" fill="none" stroke="#3e1f07" stroke-width="1.2"/>
      <!-- Knuckle highlights -->
      <path d="M25 30 Q35 25 45 28 M50 25 Q65 22 78 28" fill="none" stroke="#f4a460" stroke-width="2.5" opacity="0.4"/>
      <!-- Thumb detail -->
      <path d="M15 55 Q30 50 48 55 Q60 65 55 85" fill="none" stroke="#5d2e0a" stroke-width="3"/>
      <!-- Deep shadows -->
      <path d="M20 75 Q35 85 60 85 Q80 80 88 60" fill="none" stroke="#2b1505" stroke-width="1.5"/>
    `,
    paper: `
      ...
      <path d="M85 75 Q95 62 100 70 Q105 78 92 88 Q82 78 85 75" fill="#9370db" stroke="#483d8b" stroke-width="0.8"/>
      <path d="M45 15 Q52 3 60 10 Q68 17 55 22 Q45 17 45 15" fill="#ffffff" stroke="#483d8b" stroke-width="0.8"/>
      <!-- Ink swirls -->
      <path d="M30 35 Q50 20 70 30 M20 65 Q45 55 65 70" fill="none" stroke="#6a5acd" stroke-width="1" stroke-dasharray="2 1" opacity="0.4"/>
    `,
    scissors: `
      ...
      <path d="M55 45 L95 25 L88 70 L60 55" fill="#ffffff" stroke="#b22222" stroke-width="1.8"/>
      <!-- Yellow/Gold crossguard -->
      <rect x="38" y="55" width="24" height="6" rx="1" fill="#ffd700" stroke="#b8860b" stroke-width="1"/>
      <rect x="48" y="52" width="4" height="12" fill="#ffd700"/>
      ...
      <path d="M50 5 L50 90" fill="none" stroke="#ffd700" stroke-width="0.4" opacity="0.3"/>
    `,
    fist: `
