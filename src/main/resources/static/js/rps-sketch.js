...
const RpsSketch = (() => {
  ...
  const INK2 = '#3d69ad';
  const FINAL = {
    rock: `<svg class="rps-sketch" viewBox="0 0 80 80" aria-hidden="true">
    ...
    paper: `<svg class="rps-sketch" viewBox="0 0 80 80" aria-hidden="true">
    ...
    scissors: `<svg class="rps-sketch" viewBox="0 0 80 80" aria-hidden="true">
  ...
  function sketchHtml(choice) {
    return FINAL[choice] || FINAL.rock;
  }
  ...
  /**
   * Flipbook: cycle sketch frames then land on final choice.
   */
  ...
  function runRevealFlipbook(slotEl, finalChoice) {
    return new Promise((resolve) => {
      const host = slotEl?.querySelector('.sketch-flipbook-host');
